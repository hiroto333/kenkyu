const items = [
    { name: "懐中電灯", weight: 174, volume: 193, explanation: "停電時に必要。予備電池も忘れずに。" },
    { name: "簡易ヘルメット", weight: 450, volume: 4154, explanation: "折り畳み式ヘルメット。" },
    { name: "防災ずきん", weight: 400, volume: 2184, explanation: "耐熱耐火アルミ加工で頭部を保護。頭部を守る目的ならヘルメットの方が頑丈だが，煙対策ができる。" },
    { name: "ホイッスル", weight: 19, volume: 34, explanation: "救助を求める際に使用。電池不要で音が大きい。" },
    ...
    { name: "携帯ラジオ", weight: 89, volume: 58, explanation: "災害情報の入手に必須。手回し充電タイプが推奨。" },
    { name: "モバイルバッテリー", weight: 286, volume: 98, explanation: "スマートフォンの充電用。" },
    { name: "簡易トイレ", weight: 20, volume: 141, explanation: "簡易的なトイレ。自分に必要な分必要。" },
    { name: "ライター", weight: 15, volume: 20, explanation: "火起こしや照明用。" },
    { name: "マッチ", weight: 13, volume: 32, explanation: "防水タイプが望ましい。" },
    { name: "ろうそく", weight: 350, volume: 207, explanation: "長時間の照明として。火災に注意。" },
    { name: "ナイフ", weight: 110, volume: 373, explanation: "様々な用途に使用可能。" },
