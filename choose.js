const items = [
    ...
    { name: "防災ずきん", weight: 400, volume: 2184, explanation: "耐熱耐火アルミ加工で頭部を保護。煙対策もできる。" },
    ...
    { name: "軍手", weight: 40, volume: 220, explanation: "" },
    { name: "給水袋", weight: 70, volume: 390, explanation: "水を入れる袋。3L入る。" },
    { name: "飲料水(500ml)", weight: 520, volume: 650, explanation: "保存水。500ml。" },
    { name: "非常食(1食)", weight: 174, volume: 682, explanation: "乾パン。1食分。" },
    { name: "缶切り", weight: 47, volume: 35, explanation: "" },
    { name: "毛布", weight: 930, volume: 3812, explanation: "防寒、睡眠用。" },
    { name: "衣類・下着", weight: 950, volume: 4320, explanation: "ジャージ上下、下着を1着。" },
    { name: "レジャーシート", weight: 148, volume: 660, explanation: "" },
    { name: "使い捨てカイロ", weight: 48, volume: 24, explanation: "貼れないカイロ。" },
    { name: "アルミ製保温シート", weight: 58, volume: 260, explanation: "アルミブランケット。" },
    { name: "トイレットペーパー", weight: 112, volume: 825, explanation: "" },
    { name: "ティッシュペーパー", weight: 10, volume: 50, explanation: "ポケットティッシュ。" },
    { name: "ウェットティッシュ", weight: 65, volume: 151, explanation: "" },
    { name: "歯ブラシセット", weight: 23, volume: 266, explanation: "歯ブラシ、歯磨き粉。" },
    { name: "タオル", weight: 80, volume: 200, explanation: "" },
    { name: "石鹸", weight: 100, volume: 179, explanation: "固形石鹸。" },
    { name: "ドライシャンプー", weight: 95, volume: 385, explanation: "" },
    { name: "汗拭きシート", weight: 128, volume: 352, explanation: "" },
    { name: "ボディソープ", weight: 90, volume: 193, explanation: "" },
    { name: "救急箱", weight: 150, volume: 1320, explanation: "はさみ、ガーゼ、ばんそうこう、包帯、三角巾、脱脂綿。" },
    { name: "マスク(3枚入り)", weight: 10, volume: 34, explanation: "" },
    { name: "アルコール消毒液", weight: 108, volume: 167, explanation: "手指の消毒用。" },
    { name: "体温計", weight: 24, volume: 26, explanation: "" },
    { name: "布製ガムテープ", weight: 234, volume: 250, explanation: "" },
    { name: "ポリ袋", weight: 150, volume: 433, explanation: "" },
    { name: "筆記用具", weight: 50, volume: 70, explanation: "メモ帳、ボールペン、マジックペン。" },
    { name: "避難地図", weight: 13, volume: 25, explanation: "" },
    { name: "ロープ", weight: 750, volume: 4443, explanation: "避難に使える頑丈なロープ。" },
    { name: "乾電池(3本入り）", weight: 75, volume: 54, explanation: "乾電池3本。10年保存可能。" },
    { name: "ラップ", weight: 199, volume: 620, explanation: "" },
    { name: "アイマスク", weight: 5, volume: 20, explanation: "" },
    { name: "耳栓", weight: 1, volume: 2, explanation: "" },
    { name: "トランプ", weight: 86, volume: 80, explanation: "" },
    { name: "コンタクトレンズセット", weight: 26, volume: 40, explanation: "コンタクトレンズ，洗浄液，コンタクトケース。" },
    { name: "眼鏡", weight: 32, volume: 32, explanation: "" },
    { name: "現金・小銭", weight: 100, volume: 90, explanation: "小銭入れに2万円分の札と小銭。" },
    { name: "常備薬", weight: 25, volume: 35, explanation: "" },
    { name: "家族の写真", weight: 3, volume: 12, explanation: "" },
    { name: "緊急時の家族，親戚，知人の連絡先", weight: 13, volume: 25, explanation: "" },
    { name: "スリッパ", weight: 190, volume: 770, explanation: "頑丈な防災スリッパ。脚裏は釘なども貫通しない素材でできている。" },
    { name: "処方箋の控え", weight: 4, volume: 12, explanation: "" },
    { name: "ランタン", weight: 227, volume: 624, explanation: "" },
    { name: "洗口液", weight: 120, volume: 195, explanation: "" },
    { name: "ハンディファン", weight: 250, volume: 400, explanation: "手持ち扇風機。" },
    { name: "ヘッドライト", weight: 40, volume: 59, explanation: "" },
    { name: "冷感シート", weight: 128, volume: 352, explanation: "" },
    { name: "虫よけスプレー", weight: 80, volume: 172, explanation: "" },
    { name: "かゆみ止め", weight: 30, volume: 100, explanation: "" },
    { name: "日傘・傘", weight: 189, volume: 306, explanation: "" },
    { name: "ハンドクリーム", weight: 80, volume: 200, explanation: "" },
    { name: "リップクリーム", weight: 11, volume: 13, explanation: "。" },
    { name: "エア枕", weight: 43, volume: 65, explanation: "空気で膨らます枕。" },
    { name: "エアマット", weight: 560, volume: 774, explanation: "空気で膨らすマット。" },
    { name: "新聞紙", weight: 50, volume: 80, explanation: "" },
    { name: "食事セット", weight: 40, volume: 90, explanation: "紙皿、割り箸、フォーク、スプーンを1つずつ。" },
    { name: "ハンカチ", weight: 20, volume: 50, explanation: "" },
